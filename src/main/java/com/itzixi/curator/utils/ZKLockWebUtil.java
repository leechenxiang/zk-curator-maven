...
public class ZKLockWebUtil {
	...
	private static Logger logger = Logger.getLogger(ZKLockWebUtil.class);
	 ...
	 *            获取当前锁的所有者
	 */
	public boolean getShareLock(int type, String identity) {
	...
	public boolean unlockForShareLock() {
		try {
